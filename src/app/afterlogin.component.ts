...
export class AfterLoginComponent {
  ...
  toggleTournaments() {
    ...
    this.showRankings = false; // Close rankings when tournaments are toggled
  }
  
  toggleRankings() {
    this.showRankings = !this.showRankings;
    this.showTournaments = false; // Close tournaments when rankings are toggled
  }
  ...
  onClick(event: MouseEvent) {
    ...
    // Close the profile menu if the click is outside of the profile icon or menu
